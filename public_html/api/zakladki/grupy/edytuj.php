...
$dane = dane_wejscia_api_z_csrf(); $id = (int) ($dane['id'] ?? 0); $nazwa = trim((string) ($dane['nazwa'] ?? '')); if ($id <= 0 || mb_strlen($nazwa) < 2) odpowiedz_json(['sukces'=>false,'komunikat'=>'Nieprawidlowe dane grupy.'],422);
